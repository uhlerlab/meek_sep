...
def gnp_tree(nnodes, density=.001):
    """
    connected erdos-renyi plus tree model from choo & shirangur 22
    """
    gnp = nx.gnp_random_graph(nnodes, density)
